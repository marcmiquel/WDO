...
text_app10 = '''
        This page shows some statistics that explain how well the first 100 of the Wikipedia [Top CCC articles lists](https://wcdo.wmflabs.org/top_ccc_articles/) are spread across the other language editions. Every cell of the table is a clickable link to a Top CCC list.
